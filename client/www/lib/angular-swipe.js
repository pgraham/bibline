(function(window, angular, undefined) {
  ...
  function makeSwipeDirective(directiveName, direction, axis, eventName) {
    ngSwipe.directive(directiveName, ['$parse', 'swipe', function($parse, swipe) {
      ...
      function isTap(startCoords, endCoords) {
        var deltaY = Math.abs(startCoords.y - endCoords.y);
        var deltaX = Math.abs(startCoords.x - endCoords.x);

        return deltaY < MIN_DISTANCE && deltaX < MIN_DISTANCE;
      }
      ...
      return function(scope, element, attr) {
        ...
        var origTarget, startCoords, valid;
        ...
        swipe.bind(element, {
          ...
          'end': function(coords, event) {
            ...
            } else if (isTap(startCoords, coords)) {
              angular.element(origTarget).trigger('click');
            }
          }
        });
      };
